...
# ===========================================================================
HOST = "zthorium"   # shown as  zthorium@github  in the header

ROWS = [
    ("host",),
    ("kv", "Now", "Civil Computer Engineer"),
    ("kv", "Also", "Building AI agent systems"),
    ("kv", "Loc", "Valparaiso, Chile"),
    ("kv", "Focus", "LLM agents, medical scheduler"),
    ("gap",),
    ("sec", "Stack"),
    ("kv", "Backend", "NestJS, TypeScript, Prisma"),
    ("kv", "AI/LLM", "LangGraph, LangChain, Claude"),
    ("kv", "Data", "PostgreSQL, Redis, Firebase"),
    ("kv", "Deploy", "Docker, AWS RDS"),
    ("gap",),
    ("sec", "Highlights"),
    ("bul", "LangGraph medical scheduling assistant"),
    ("bul", "Civil Comp. Eng. @ Univ. de Valparaiso"),
]
